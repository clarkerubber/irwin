...
class Evaluation:
    ...
    def evaluate(self):
        ...
        activations = [self.activation([self.gameActivation(gp) for gp in self.predictAnalysed(gameAnalysisStore.gameAnalysisTensors())]) for player, gameAnalysisStore in analysisStoreByPlayer]
